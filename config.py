...
flags.DEFINE_integer(
    "num_val_examples_per_class", 1, "Number of validation samples per class "
                                     "in a task instance.")
flags.DEFINE_integer("metatrain_batch_size", 4, "Number of problem instances "
                                                "in a batch.")
flags.DEFINE_integer("metavalid_batch_size", 20, "Number of meta-validation "
                                                 "problem instances.")
flags.DEFINE_integer("metatest_batch_size", 20, "Number of meta-testing "
                                                "problem instances.")
